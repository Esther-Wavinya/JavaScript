...
If compareFunc(a, b) returns less than 0 - negative number.    Sort a before b
If compareFunc(a, b) returns 0.    Leave a and b unchanged with respect to each other
If compareFunc(a, b) returns greater than 0 - positive number.   Sort b before a
use slice to make a copy of array to not mutate directly
 */
// Ascending Sort:
